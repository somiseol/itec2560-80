...
const addStudent = () => {
    formErrors.value = [] // clear errors list
    ...
    if (!newStarID.value) {
        formErrors.value.push('StarID must be enterd')
    }
...
<div id="new-student-form" class="card add-student m-2 p-2">
    ...
    <div class="form-group mb-3">
        ...
        <input for="name" class="form-control" v-model.trim="newStudentName">
    </div>
    <div class="form-group mb-3">
        <label for="starID">StarID</label>
        <input id="starID" class="form-control" v-model.trim="newStarID">
    </div>
        <button class="btn btn-primar" v-on:click="addStudent">Add</button>
</div>
